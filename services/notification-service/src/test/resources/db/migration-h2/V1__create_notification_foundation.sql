-- H2 test equivalent of the production V1 migration. It intentionally retains the same columns,
-- constraints, and indexes so Hibernate validation catches persistence mapping drift.
