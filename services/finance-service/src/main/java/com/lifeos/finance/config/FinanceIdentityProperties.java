...
/** Identity authority connection, workload credentials, and bounded outbound-call settings. */
@ConfigurationProperties(prefix = "identity")
@Validated
public class FinanceIdentityProperties {

    @NotBlank(message = "baseUrl must be configured")
    private String baseUrl = "http://localhost:8081";

    @NotBlank(message = "workloadIdentity must be configured")
    private String workloadIdentity = "finance-service";
