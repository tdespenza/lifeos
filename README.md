...
* **gateway-service** — the public REST ingress with configuration-owned routing, correlation IDs, Redis-backed per-route/client rate limits, and isolated upstream timeouts, bulkheads, and circuit breakers. See [`docs/api/gateway-service.md`](docs/api/gateway-service.md).
