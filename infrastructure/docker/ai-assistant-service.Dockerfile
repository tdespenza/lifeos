# The executable jar is produced by Gradle before the image build. Pin the hardened UBI runtime
# digest so deployment does not silently inherit a mutable base image.
