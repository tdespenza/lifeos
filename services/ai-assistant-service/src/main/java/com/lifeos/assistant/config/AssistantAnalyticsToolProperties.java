...
/** Bounded settings for the workload-authenticated Analytics recommendation projection. */
@ConfigurationProperties(prefix = "assistant.analytics-tool")
@Validated
public class AssistantAnalyticsToolProperties {
    ...
    public String getGatewayProofSecret() { return gatewayProofSecret; }
    public void setGatewayProofSecret(String gatewayProofSecret) { this.gatewayProofSecret = gatewayProofSecret; }
    ...
    public boolean configured() {
        return baseUrl != null && !baseUrl.isBlank()
                ...
                && gatewayProofSecret != null && !gatewayProofSecret.isBlank();
    }
    ...
    public boolean isConnectTimeoutPositive() { return isPositive(connectTimeout); }

    @AssertTrue(message = "readTimeout must be positive")
    public boolean isReadTimeoutPositive() { return isPositive(readTimeout); }

    private static boolean isPositive(Duration value) { return value != null && !value.isZero() && !value.isNegative(); }
