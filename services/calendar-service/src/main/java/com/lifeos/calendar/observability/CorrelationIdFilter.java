...
/** Establishes a redacted correlation context for Calendar audit, logs, and outbound calls. */
@Component
    ...
    protected void doFilterInternal(
        ...
        try (MDC.MDCCloseable ignored = MDC.putCloseable("correlationId", correlationId)) {
            try {
                ...
                throw new ServletException("calendar request context propagation failed", exception);
            }
        }
    }
}
