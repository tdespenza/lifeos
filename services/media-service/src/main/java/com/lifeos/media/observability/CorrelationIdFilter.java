...
/** Establishes privacy-safe correlation context for logs, audit, and outbound calls. */
@Component
    ...
    protected void doFilterInternal(
        ...
        try (MDC.MDCCloseable ignored = MDC.putCloseable("correlationId", correlationId)) {
            try {
                ...
                throw new ServletException("media request context propagation failed", exception);
            }
        }
    }
}
