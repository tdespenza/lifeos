...
**Engineering Labs** (added during implementation-readiness review — missing from the first extraction pass)
...
**Interview Documentation** (added during implementation-readiness review — missing from the first extraction pass)
...
**CI/CD Pipeline** (expanded during implementation-readiness review — REQUIREMENTS.md names 14 individual stages, originally collapsed into one NFR)
