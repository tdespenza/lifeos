...
/** Bounded, opt-in connection settings for aggregate-only Finance insight reads. */
@ConfigurationProperties(prefix = "assistant.finance-tool")
@Validated
public class AssistantFinanceToolProperties {
