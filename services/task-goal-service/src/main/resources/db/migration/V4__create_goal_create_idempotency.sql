-- Durable, scope-bound reservation for idempotent POST /api/v1/goals requests.
-- The application stores SHA-256 digests of the client key and canonical request, not their raw values.
