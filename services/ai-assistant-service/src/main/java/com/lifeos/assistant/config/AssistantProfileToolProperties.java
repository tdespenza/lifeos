...
/** Bounded, opt-in connection settings for consented Profile journal reads. */
@ConfigurationProperties(prefix = "assistant.profile-tool")
@Validated
public class AssistantProfileToolProperties {
