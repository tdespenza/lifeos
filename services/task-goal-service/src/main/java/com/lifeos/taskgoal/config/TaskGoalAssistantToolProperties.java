...
/** Credentials for the narrow AI-assistant task mutation boundary. */
@ConfigurationProperties(prefix = "task-goal.assistant-tool")
public class TaskGoalAssistantToolProperties {
